...
const dispenseOne = store.dispatch(addExpense({
    description: 'Rent',
    amount: 100,
    createdAt: 1000
}));
...
const dispenseTwo = store.dispatch(addExpense({
    description: 'Coffee',
    amount: 300,
    createdAt: -1000
}));
// store.dispatch(removeExpense({
//     id: dispenseOne.expense.id
// }));
//
// store.dispatch(editExpense(dispenseTwo.expense.id, { amount: 500 }));
